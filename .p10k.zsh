# Generated by Powerlevel10k configuration wizard on 2026-03-18 at 22:55 CDT.
...
() {
  ...
  # The list of segments shown on the left. Keep the hot path lean.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    dir                     # current directory
    vcs                     # git status
  )

  # The list of segments shown on the right. Trim expensive environment/version checks.
